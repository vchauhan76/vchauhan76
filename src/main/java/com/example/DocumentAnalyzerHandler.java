...
public class DocumentAnalyzerHandler implements RequestHandler<S3Event,String> {
    ...
    public String handleRequest(S3Event s3Event, Context context) {
        ...
        try {
            ...
            knowledgeBaseText =  knowledgeBaseRetriever.retrieve("can you provide information based on cost optimization pillar and finance lense", KNOWLEDGE_BASE_ID); // TODO enhance with lense filter.
            ...
            String prompt= reviewPromt.createReviewPrompt(extractedText, knowledgeBaseText, "FinancialServicesIndustryLense", "CostOptimizationPillar", "is this architecure fit for finance industry ?");
